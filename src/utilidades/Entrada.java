	...
	public static int entero() {
            ...
            do {
                    try {
                            ...
                            System.out.println("ERROR: Esperaba un entero");
                    }
            } while (!leido);
            return valor;
	}
	...
	public static long enteroLargo() {
            ...
            do {
                    try {
                            ...
                            System.out.println("ERROR: Esperaba un entero largo");
                    }
            } while (!leido);
            return valor;
	}
	...
	public static float real() {
            ...
            do {
                    try {
                            ...
                            System.out.println("ERROR: Esperaba un real");
                    }
            } while (!leido);
            return valor;
	}
	...
	public static double realDoble() {
            ...
            do {
                    try {
                            ...
                            System.out.println("ERROR: Esperaba un real de doble precisión");
                    }
            } while (!leido);
            return valor;
	}
	...
	public static char caracter() {
            ...
            do {
                    ...
                    if (valor.length() == 1)
                            ...
                            System.out.println("ERROR: Esperaba un caracter");
            } while (!leido);
